...
namespace Turbo_Az.Migrations
{
    ...
    partial class Db_TurboModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Turbo_Az.Models.Advertisement", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AdYear = new DateTime(2019, 8, 14, 11, 41, 21, 21, DateTimeKind.Local), CarInfo = "Biraz orasin-burasin vurmusam", CityId = 1, ColorId = 1, FuelId = 1, GradiuationYearId = 1, Hiking = 12000, IsVip = false, MachinePowerId = 4, ModelId = 1, PhotoURL = "bmv.jpg", Price = 25000m, SpeedId = 2, UpdateYear = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                        new { Id = 2, AdYear = new DateTime(2019, 8, 14, 11, 41, 21, 24, DateTimeKind.Local), CarInfo = "Biraz orasin-burasin vurmusam", CityId = 2, ColorId = 3, FuelId = 1, GradiuationYearId = 1, Hiking = 8000, IsVip = true, MachinePowerId = 4, ModelId = 3, PhotoURL = "car2.jpg", Price = 50000m, SpeedId = 1, UpdateYear = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                        new { Id = 3, AdYear = new DateTime(2019, 8, 14, 11, 41, 21, 24, DateTimeKind.Local), CarInfo = "Biraz orasin-burasin vurmusam", CityId = 3, ColorId = 2, FuelId = 2, GradiuationYearId = 2, Hiking = 76000, IsVip = false, MachinePowerId = 4, ModelId = 2, PhotoURL = "car1.jpg", Price = 17000m, SpeedId = 2, UpdateYear = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                        new { Id = 5, AdYear = new DateTime(2019, 8, 14, 11, 41, 21, 24, DateTimeKind.Local), CarInfo = "Biraz orasin-burasin vurmusam", CityId = 1, ColorId = 1, FuelId = 1, GradiuationYearId = 1, Hiking = 12000, IsVip = true, MachinePowerId = 4, ModelId = 3, PhotoURL = "car2.jpg", Price = 25000m, SpeedId = 2, UpdateYear = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                    );
                });

            modelBuilder.Entity("Turbo_Az.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Turbo_Az.Models.AppUser")
                        .WithMany()
